...
print("4. Parameter files available in 'params/' folder with multiple quality levels:")
print("   - HalfCheetah: expert, medium_high, medium, random")
print("   - Hopper: expert, medium_high, medium, random") 
print("   - Walker2d: expert, medium, medium_low, random")
print("5. Use test_parameter_files.py to verify parameter file support")
print("6. Test BC: python train_mujoco.py --env HalfCheetah-v4 --bc_loss 1 --demo_file demo_data/halfcheetah_expert_demos.npz")
print("7. Test Q-Filter: python train_mujoco.py --env HalfCheetah-v4 --bc_loss 1 --q_filter 1 --demo_file demo_data/halfcheetah_expert_demos.npz")